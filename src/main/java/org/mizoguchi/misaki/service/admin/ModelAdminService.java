...
public interface ModelAdminService {
    ...
    PageResult<ModelAdminResponse> searchModels(@Positive Integer pageIndex, @Positive Integer pageSize, String sortField, String sortOrder, SearchModelAdminRequest searchModelAdminRequest);
